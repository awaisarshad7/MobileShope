  ...
  <div class="row presentation">
    ...
    <div class="col-lg-4 col-md-6">
      <ul class="list-unstyled list">
        ...
        <li><i class="fa fa-check"></i>Based on <a href="http://getbootstrap.com/javascript/#tabs" target="_blank">Bootstrap Tabs</a><li>
        <li><i class="fa fa-check"></i>Variety<li>
        <li><i class="fa fa-check"></i>Color Options<li>
        <li><i class="fa fa-check"></i>Columns<li>
      </ul>
    </div>
            ...
            <div class="panel-body">
                ...
                <div role="tabpanel">
                  ...
                  <ul class="nav nav-pills nav-stacked col-md-4" role="tablist">
                    <li role="presentation" class="active"><a href="#home3" aria-controls="home2" role="tab" data-toggle="tab">Home</a></li>
                    <li role="presentation"><a href="#profile3" aria-controls="profile3" role="tab" data-toggle="tab">Profile</a></li>
                    <li role="presentation"><a href="#messages3" aria-controls="messages3" role="tab" data-toggle="tab">Messages</a></li>
                  </ul>
            ...
            <div class="panel-body">
                ...
                <div role="tabpanel">
                  ...
                  <ul class="nav nav-pills nav-icon" role="tablist">
                    <li role="presentation" class="active"><a href="#home6" aria-controls="home6" role="tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
                    <li role="presentation"><a href="#profile6" aria-controls="profile6" role="tab" data-toggle="tab"><i class="fa fa-user"></i></a></li>
                    <li role="presentation"><a href="#messages6" aria-controls="messages6" role="tab" data-toggle="tab"><i class="fa fa-comment"></i></a></li>
                    <li role="presentation"><a href="#settings6" aria-controls="settings6" role="tab" data-toggle="tab"><i class="fa fa-shopping-cart"></i></a></li>
                  </ul>
            ...
            <div class="panel-body">
                ...
                <div role="tabpanel">
                  ...
                  <div class="tabs-left">
                      ...
                      <li role="presentation" class="active"><a href="#home7" aria-controls="home7" role="tab" data-toggle="tab">Home</a></li>
                      <li role="presentation"><a href="#profile7" aria-controls="profile7" role="tab" data-toggle="tab">Profile</a></li>
                      <li role="presentation"><a href="#messages7" aria-controls="messages7" role="tab" data-toggle="tab">Messages</a></li>
                    </ul>
                    <!-- Tab panes -->
                    <div class="tab-content">
                      <div role="tabpanel" class="tab-pane active" id="home7">
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque sapien lorem, rhoncus sit amet sodales ut.</p>
                      </div>
                      <div role="tabpanel" class="tab-pane" id="profile7">
                        <p>Maecenas a pretium odio. Curabitur et sem augue. Phasellus vel bibendum arcu. Nullam porttitor ultrices eleifend.</p>
                      </div>
                      <div role="tabpanel" class="tab-pane" id="messages7">
                        <p>Vestibulum venenatis euismod turpis, vitae accumsan nunc ullamcorper ac. Lorem ipsum dolor sit amet</p>
                      </div>
                    </div>
            ...
            <div class="panel-body">
                ...
                <div role="tabpanel">
                  ...
                  <div class="tabs-right">
                      <ul class="nav nav-tabs">
                      <li role="presentation" class="active"><a href="#home8" aria-controls="home8" role="tab" data-toggle="tab">Home</a></li>
                      <li role="presentation"><a href="#profile8" aria-controls="profile8" role="tab" data-toggle="tab">Profile</a></li>
                      <li role="presentation"><a href="#messages8" aria-controls="messages8" role="tab" data-toggle="tab">Messages</a></li>
                    </ul>
                    <!-- Tab panes -->
                    <div class="tab-content">
            ...
            <div class="panel-body">
                ...
                <div role="tabpanel">
                  ...
                  <ul class="nav nav-tabs font-title-tab" role="tablist">
                    <li role="presentation" class="active"><a href="#home9" aria-controls="home9" role="tab" data-toggle="tab">Home</a></li>
            ...
            <div class="panel-body">
                ...
                <div role="tabpanel">
                  ...
                  <ul class="nav nav-tabs tabcolor5-bg" role="tablist">
                    <li role="presentation" class="active"><a href="#home10" aria-controls="home10" role="tab" data-toggle="tab">Home</a></li>
            ...
            <div class="panel-body">
                ...
                <div role="tabpanel">
                  ...
                  <ul class="nav nav-tabs tabcolor6-bg" role="tablist">
                    <li role="presentation" class="active"><a href="#home11" aria-controls="home11" role="tab" data-toggle="tab">Home</a></li>
                    <li role="presentation"><a href="#profile11" aria-controls="profile11" role="tab" data-toggle="tab">Profile</a></li>
            ...
            <div class="panel-body">
                ...
                <div role="tabpanel">
                  ...
                  <ul class="nav nav-tabs tabcolor7-bg" role="tablist">
                    <li role="presentation" class="active"><a href="#home12" aria-controls="home12" role="tab" data-toggle="tab">Home</a></li>
                    <li role="presentation"><a href="#profile12" aria-controls="profile12" role="tab" data-toggle="tab">Profile</a></li>
                    <li role="presentation"><a href="#messages12" aria-controls="messages12" role="tab" data-toggle="tab">Messages</a></li>
                  </ul>
            ...
            <div class="panel-body">
                ...
                <div role="tabpanel">
                  ...
                  <ul class="nav nav-tabs tabcolor8-bg" role="tablist">
                    <li role="presentation" class="active"><a href="#home13" aria-controls="home13" role="tab" data-toggle="tab">Home</a></li>
                    <li role="presentation"><a href="#profile13" aria-controls="profile13" role="tab" data-toggle="tab">Profile</a></li>
                    <li role="presentation"><a href="#messages13" aria-controls="messages13" role="tab" data-toggle="tab">Messages</a></li>
                  </ul>
            ...
            <div class="panel-body">
                ...
                <div role="tabpanel">
                  ...
                  <ul class="nav nav-tabs tabcolor9-bg" role="tablist">
                    <li role="presentation" class="active"><a href="#home14" aria-controls="home14" role="tab" data-toggle="tab">Home</a></li>
                    <li role="presentation"><a href="#profile14" aria-controls="profile14" role="tab" data-toggle="tab">Profile</a></li>
                    <li role="presentation"><a href="#messages14" aria-controls="messages14" role="tab" data-toggle="tab">Messages</a></li>
                  </ul>
            ...
            <div class="panel-body">
                ...
                <div role="tabpanel">
                  ...
                  <ul class="nav nav-tabs tabcolor10-bg" role="tablist">
                    <li role="presentation" class="active"><a href="#home15" aria-controls="home15" role="tab" data-toggle="tab">Home</a></li>
                    <li role="presentation"><a href="#profile15" aria-controls="profile15" role="tab" data-toggle="tab">Profile</a></li>
                    <li role="presentation"><a href="#messages15" aria-controls="messages15" role="tab" data-toggle="tab">Messages</a></li>
                  </ul>
  ...
  <div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane active" id="today">
      ...
      <ul class="list-w-title">
        ...
        </li><img src="http://www.wplocker.com/e3dd.jpg">
      </ul>
