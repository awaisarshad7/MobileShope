...
<div class="content">
  ...
  <div class="row presentation">
    ...
    <div class="col-lg-8 col-md-6 titles">
      <span class="icon color11-bg"><i class="fa fa-tasks"></i></span>
      <h1>Progress Bars</h1>
      <h4>Provide up-to-date feedback on the progress of a workflow or action <br>with simple yet flexible progress bars.</h4>
    </div>

    <div class="col-lg-4 col-md-6">
      <ul class="list-unstyled list">
        <li><i class="fa fa-check"></i>Color Options<li>
        <li><i class="fa fa-check"></i>Animated<li>
        <li><i class="fa fa-check"></i>Sizeable<li>
        <li><i class="fa fa-check"></i>Based on <a href="hhttp://getbootstrap.com/components/#progress" target="_blank">Bootstrap Progress Bars</a><li>
      </ul>
    </div>
    ...
    <div class="col-md-12 col-lg-4">
      <div class="panel">
        ...
        <div class="panel-body">
            ...
            <div class="progress">
              <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width: 33%;">
                Step 1
              </div>
              <div class="progress-bar" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 33%;">
                Step 2
              </div>
            </div>
            ...
            <div class="progress">
              <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width: 20%;">
                Used
              </div>
              <div class="progress-bar progress-bar-transparent" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 80%;">
                Empty Space
              </div>
            </div>
    ...
    <div class="col-md-12 col-lg-4">
      <div class="panel">
        ...
        <div class="panel-body">
            ...
            Extra Large
            <div class="progress progress-extralarge">
              <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;">
                <span class="sr-only">60% Complete</span>
              </div>
            </div>
